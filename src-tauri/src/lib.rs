...
use adapters::{
    ...
    tauri::commands::{
        cancel_agent_run, clear_acp_session, create_github_pull_request,
        create_pull_request_review_draft, create_saved_prompt, create_workspace_commit,
        delete_pull_request_review_draft, delete_saved_prompt, get_github_pull_request_context,
        get_window_bootstrap, get_workspace_git_status, list_acp_sessions, list_agents,
        list_pull_request_review_drafts, list_saved_prompts, list_workbench_windows,
        list_workspace_checkouts, list_workspaces, load_goal_file, open_workbench_window,
        provision_workspace_task_worktree, push_workspace_branch, record_saved_prompt_used,
        ...
        submit_github_pull_request_review, summarize_workspace_diff,
